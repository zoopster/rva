...
public class FlexTableUtil {
  ...
  /**
   * Copies the CSS style of a source cell to a target cell.
   * 
   * @param sourceTable
   * @param targetTable
   * @param sourceRow
   * @param targetRow
   */
  private static void copyCellStyle(FlexTable sourceTable, FlexTable targetTable, int sourceRow, int sourceCol,
      int targetRow, int targetCol) {
    String cellStyle = sourceTable.getCellFormatter().getStyleName(sourceRow, sourceCol);
    targetTable.getCellFormatter().setStyleName(targetRow, targetCol, cellStyle);
  }
