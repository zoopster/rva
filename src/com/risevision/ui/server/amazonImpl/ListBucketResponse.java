...
public class ListBucketResponse extends Response {
     ...
     */
    public List<MediaItemInfo> entries = null;
    ...
    public ListBucketResponse(HttpURLConnection connection) throws IOException, ServiceFailedException {
        super(connection);

        listBucketResponse(connection.getInputStream());
    }
    
    public ListBucketResponse(InputStream stream) throws IOException, ServiceFailedException {
        super(null);

        listBucketResponse(stream);
    }
    
    public void listBucketResponse(InputStream stream) throws IOException, ServiceFailedException {
    ...
    class ListBucketHandler extends DefaultHandler {
        ...
        private MediaItemInfo keyEntry = null;
        ...
        public void startElement(String uri, String name, String qName, Attributes attrs) {
            if (name.equals("Contents")) {
                this.keyEntry = new MediaItemInfo();
            } else if (name.equals("Owner")) {
                this.keyEntry.setOwner(new MediaItemInfo.Owner());
        ...
        public void endElement(String uri, String name, String qName) {
            ...
            } else if (name.equals(MediaItemInfo.KEY_ATTRIBUTE)) {
//            	this.keyEntry.setKey(this.currText.toString().replace("+", " "));
            	this.keyEntry.setKey(this.currText.toString());
            } else if (name.equals(MediaItemInfo.LAST_MODIFIED_ATTRIBUTE)) {
                try {
            ...
            } else if (name.equals(MediaItemInfo.SIZE_ATTRIBUTE)) {
